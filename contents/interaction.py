...
def interaction_intro():
    st.write("""
    Now, you will interact with a generative AI chatbot. 
    You will ask the chatbot some questions and it will respond. 
    Please read the instructions below carefully

    >
    > 1. On the next page, you will see a list of questions. Select one question and type it into the chat box.
    > 2. Carefully review the chatbot’s answer.
    > 3. Rate the accuracy of the answer. 
    >

    ou will ask the chatbot a total of 13 different questions. Click `Next` if you are ready to begin.
...
def interaction_page():
    ...
    st.markdown(f"""
    **:blue[1. Click a question from the list to auto-fill it into the interaction box.]**  
    **:blue[2. Alternatively, type a question manually into the box.]**  
    **:blue[3. Click 'Submit' to ask your question and see the AI's response.]**  
    ...
    with col2:
        ...
        st.write("---")
        st.write("### Interaction Box")
        user_input = st.text_input(
            "Type your question here *(select one of the questions from the left)*:",
